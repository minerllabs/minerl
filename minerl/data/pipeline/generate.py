"""
Use startRecording and stopRecording markers to clip experiment videos from the large
video recordings generated by merge. Also clips univ.json, which contains the information
needed to reconstruct observations and actions (used by the next stage, publish.py).

For some diamond trajectories, this script also modifies the experiment name based on
the items encountered (o_bed => o_bed/yellow).
"""
import functools
