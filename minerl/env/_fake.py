...
class _FakeEnvMixin(object):
    ...
    def step(self, action) -> Tuple[
        ...
        info = {a: {} for a in self.task.agent_names}
        obs = self.observation_space.sample()
        return obs, reward, done, info


class _PreRecordedEnvMixin(_FakeEnvMixin):
    ...
    def __init__(self, *args, **kwargs):
        super(_PreRecordedEnvMixin, self).__init__(*args, **kwargs)
...
class _PreRecordedMultiAgentEnv(_PreRecordedEnvMixin, _MultiAgentEnv):
    """A pre-recorded multiagent environment."""
    pass


class _PreRecordedSingleAgentEnv(_PreRecordedEnvMixin, _SingleAgentEnv):
    """A pre-recorded singleagent environment."""
