...
from herobraine.hero.agent_handler import HandlerCollection, AgentHandler
from herobraine.hero.handlers import RewardHandler
...
class DataPipelineWithReward:
    ...
    def __init__(self,
        ...
        :param data_directory: the directory of the data to be loaded, eg: 'herobraine_parse/output/rendered/'
        """
